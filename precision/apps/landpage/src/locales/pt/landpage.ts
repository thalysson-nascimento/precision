export const landpage = {
  ...
  pricingCurrencyLabelUSD: 'Exibindo valores em Dólar (USD) com base na sua localização.',
  pricingCurrencyLabelCAD: 'Exibindo valores em Dólar Canadense (CAD) com base na sua localização.',
