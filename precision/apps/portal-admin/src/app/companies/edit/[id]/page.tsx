...
export default function EditCompanyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!number.trim()) {
      showToast('O número é obrigatório.', 'error');
      return;
    }
    if (!contact.trim()) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.error || 'Erro ao atualizar empresa');
      }
          ...
          <div className="flex-1 overflow-y-auto p-container-margin md:p-xl">
            <div className="max-w-[800px] mx-auto flex flex-col gap-xl">
              ...
              <section className="flex flex-col gap-xs">
                ...
                <h1 className="font-headline-lg text-headline-lg text-on-surface mt-sm">Editar Empresa</h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant">Altere as informações da empresa selecionada.</p>
              </section>
