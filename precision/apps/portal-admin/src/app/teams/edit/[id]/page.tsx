  ...
  useEffect(() => {
    const fetchTeam = async () => {
      try {
        ...
        console.error(err);
        showToast(err.message || 'Erro ao carregar dados da equipe.', 'error');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.error || 'Erro ao atualizar equipe');
      }
      ...
      console.error(err);
      showToast(err.message || 'Erro ao atualizar equipe.', 'error');
      setSubmitting(false);
    }
  };
          ...
          <div className="flex-1 overflow-y-auto p-container-margin md:p-xl">
            <div className="max-w-[800px] mx-auto flex flex-col gap-xl">
              ...
              <section className="flex flex-col gap-xs">
                ...
                <h1 className="font-headline-lg text-headline-lg text-on-surface mt-sm">Editar Equipe</h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant">Altere o nome da equipe selecionada.</p>
              </section>
